...
get_content_value(observe, Content) -> Content#coap_content.size1;
get_content_value(block1, Content) -> Content#coap_content.size1;
get_content_value(block2, Content) -> Content#coap_content.size1;
